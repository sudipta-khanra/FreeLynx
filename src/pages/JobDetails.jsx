...
// 🛠️ ওল্ড axios বদলে তোমার সেন্ট্রাল ইনস্ট্যান্সটি ইম্পোর্ট করা হলো
...
export default function JobDetails() {
  ...
  const fetchJob = async () => {
    try {
      // 🛠️ ইউআরএল ক্লিন করা হলো এবং হেডার্স বাদ দেওয়া হলো (ইনস্ট্যান্স অটোমেটিক টোকেন পাঠাবে)
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      // 🛠️ এখানেও ক্লিন ইউআরএল রাউট ব্যবহার করা হলো
