...
// 🛠️ ১. তোমার তৈরি করা axiosInstance (api) ইম্পোর্ট করো
...
export default function PostJob() {
  ...
  // 🛠️ ২. onSubmit ফাংশনটি axiosInstance দিয়ে আপডেট করা হলো
  const onSubmit = async (data) => {
    setIsSubmitting(true);
    try {
      // এখানে সরাসরি api.post ব্যবহার করায় এটি লোকাল ও লাইভ (env) দুই জায়গাতেই অটোমেটিক কাজ করবে।
      // আলাদা করে headers বা টোকেন দেওয়া লাগবে না, কারণ axiosInstance-এর ইন্টারসেপ্টর ওটা হ্যান্ডেল করছে।
