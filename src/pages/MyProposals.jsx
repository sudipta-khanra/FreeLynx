...
export default function MyProposals() {
  ...
  const fetchProposals = async () => {
    try {
      setLoading(true);
      // 🛠️ ইউআরএল ক্লিন করা হলো এবং ম্যানুয়াল headers বাদ দেওয়া হলো
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setShowModal(false);
      // 🛠️ ইউআরএল ক্লিন করা হলো এবং ম্যানুয়াল headers বাদ দেওয়া হলো
      await axios.delete(`/proposals/${proposalToDelete}`);
          ...
          {filteredProposals.map((proposal) => (
            ...
            >
              ...
              <div className="mt-6 flex gap-4">
                {/* 🛠️ এখানে অপショナル চেইনিং দেওয়া হলো যাতে jobId ডিলিট হয়ে গেলেও অ্যাপ ক্র্যাশ না করে */}
                <Link
                  to={proposal.jobId?._id ? `/jobs/${proposal.jobId._id}` : '#'}
                ...
                >
                  {proposal.jobId?._id ? 'View Job' : 'Job Unavailable'}
                </Link>
                <button
